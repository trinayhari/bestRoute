#!/usr/bin/env python3
"""
OpenRouter LLM Suite - Model Comparison

Compare responses from multiple LLMs side by side to evaluate performance and suitability for various tasks.
"""
...
# Page config
st.set_page_config(
    page_title="OpenRouter LLM Suite - Model Comparison",
    page_icon="🔍",
    layout="wide",
